...
export const getComment = params => get('/course/info/comment', params);
export const getCommentCount = params => get('/course/info/comment/count', params);
export const addComment = data => post('/course/info/comment', data);
